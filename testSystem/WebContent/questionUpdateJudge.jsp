			...
			<form action="${pageContext.request.contextPath }/teacher/question" method="post" class="form-horizontal" id="addQuestion">
				...
				<div class="question">
					<div class="form-group">
						<div class="col-sm-10">
							<div>
								<textarea class="form-control" placeholder="题干" name="questionContent">${question.questionContent }</textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="question">
						...
						<div class="col-sm-4">
							<div>
								<select class="form-control" name="answer" id="answer">
									<option value="1" ${question.answer == 1 ? "selected='selected'" : "" }>正确</option>
									<option value="0" ${question.answer == 0 ? "selected='selected'" : "" }>错误</option>
								</select>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea class="form-control" placeholder="题目解析" name="questionExplain" id="questionExplain">${question.questionExplain }</textarea>
						</div>
					</div>
				</div>
