			...
			<form action="${pageContext.request.contextPath }/teacher/question" method="post" class="form-horizontal" id="addQuestion">
				...
				<div class="question">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div>
								<textarea class="form-control" placeholder="正确答案" name="answer" id="answer">${question.answer }</textarea>
							</div>
						</div>
					</div>
					<div class="form-group">
