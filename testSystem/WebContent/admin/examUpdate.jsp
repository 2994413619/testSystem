...
<html>
	...
	<body>
		<!--createTestCss(和老师学生修改试卷使用的同一个css)-->
		<link rel="stylesheet" href="../myCss/createTest.css" />
		
		<!--createTestJs-->
		<script type="text/javascript" src="js/examUpdate.js" ></script>
			...
			<div class="row col-lg-2 col-md-2 hidden-sm hidden-xs" id="addQuestion">
				...
				<form class="form-horizontal" id="scoreSet">
					...
					<div class="form-group">
					    <label for="examOwn" class="col-sm-3 control-label">出卷人</label>
					    <div class="col-sm-8">
					      	<input type="text" class="form-control" id="examOwn" name="examOwn" placeholder="出卷人" value="jack">
					    </div>
					</div>
					<div class="form-group">
					    ...
					    <div class="col-sm-8">
					      	<select id="forPeople" name="forPeople" class="form-control">
					      		<option value="mine">出卷人的学生</option>
				...
				<form id="newTestForm">
					...
					<div class="row questionDiv" index="1" questionType="radio">
						...
						<div class="col-lg-9" questionContent="1">
							<textarea class="form-control questionStem" autocomplete="off" placeholder="请输入题干" name="1questionStem" oninput="changeRows(this)">对于import java.util包，以下那种说法是错误的？</textarea>
					...
					<div class="row questionDiv" index="4" questionType="gapFilling">
						...
						<div class="col-lg-9" questionContent="4">
							...
							<div class="form-group checkItem" id="4chooseDiv1">
							    ...
							    <textarea class="form-control questionStem" autocomplete="off" placeholder="请输入题干" name="4questionStem1" style="margin-top:20px;" oninput="changeRows(this)" oninput="changeRows(this)">是所有类的根类</textarea>
							</div>
						</div>
						<div class="col-lg-2">
