		...
		<div class="container">
			<div class="mylabel">
				<h3>
					...
					<span class="label label-primary">判断题</span>
			...
			<div class="question">
				...
				<form action="${pageContext.request.contextPath }/student/question" method="post">
					<input type="hidden" name="method" value="checkAnswerJudge" />
					<input type="hidden" name="questionId" value="${question.questionId }" />
					<input type="hidden" name="type" value="3" />
					<label class="radio-inline">
						<input type="radio" name="answer" id="inlineRadio1" value="1" required="required"> 
						<span class="glyphicon glyphicon-ok"></span>
					</label>
					<label class="radio-inline">
						<input type="radio" name="answer" id="inlineRadio2" value="0" required="required">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel" style="color: #00E0B0;">
									正确答案：
									<c:if test="${question.answer==1 }">
										<span class="glyphicon glyphicon-ok" style="color: #00E0B0;"></span>
									</c:if>
									<c:if test="${question.answer==0 }">
										<span class="glyphicon glyphicon-remove" style="color: #00E0B0;"></span>
									</c:if>
								</h4>
							</div>
