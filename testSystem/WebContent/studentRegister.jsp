...
<!--registerCss-->
		...
		<script type="text/javascript" src="myjs/studentRegister.js" ></script>
		...
		<div class="container-fluid registerHtml">
			<div class="divForm col-lg-4 col-md-6 col-sm-8 col-xs-10 col-lg-offset-4 col-md-offset-3 col-sm-offset-2 col-xs-offset-1">
				<form action="${pageContext.request.contextPath }/User" method="POST" class="form-horizontal" id="register">
					<input type="hidden" name="method" value="studentRegister" />
					<legend>学生注册</legend>
					<div class="form-group">
						<label for="myTeacherId" class="col-sm-3 control-label hidden-xs">
							指导老师
							<span style="color: red;">*</span>
						</label>
						<div class="col-sm-6">
							<input type="number" class="form-control" id="myTeacherId" name="myTeacherId" placeholder="指导老师编号*" autocomplete="off">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<textarea class="form-control" id="signature" name="signature" placeholder="个性签名" style="resize: none;"></textarea>
						</div>
					</div>
					<div class="form-group">
